<div class="panel">
    <div class="panel-body">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{#URL_DIR#}produtos">Home</a></li>
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="{#URL_DIR#}categorias/incluir" class="btn btn-success btn-sm">
                ...
                <tr>
                    ...
                    <td class="acoes_categorias">
                        <a class="text-primary" id="editar"
                            href="{#URL_DIR#}categorias/alterar/{$lista_categorias[sec1].id}">
                            <i class="far fa-edit"></i>
                        </a>
                        <a class="text-danger"
                            href="{#URL_DIR#}categorias/excluir/{$lista_categorias[sec1].id}">
