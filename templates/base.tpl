...
<head>
    ...
    <link rel="stylesheet" href="{$LIB_DIR}css/dataTables.bootstrap4.css" />
    <!-- MAIN CSS -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="brand">
                <a href="index.html"><img src="{$LIB_DIR}img/logo-dark.png" alt="Anhangá Logo" class="img-responsive logo"></a>
            </div>
            ...
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav">
                        ...
                        <li>
                            <a href="#menu_produtos" data-toggle="collapse" class="collapsed {if $menu_ativo == "produtos"}active{/if}"> <i class="fa fa-box-open"></i> <span>Produtos</span> <i
    ...
    <script src="{$LIB_DIR}js/datatables.min.js"></script>
    <script>
        $(function () {
            var data, options;
