...
<div class="form-group col-lg-6 col-md-8 col-sm-10">
  <a href="index.php?pagina=usr_app{if isset($id_atualiza)}&id={$id_atualiza}{/if}" class="btn btn-primary">OK</a>
</div>
{else}
  ...
  <div class="panel-body">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{$URL}index.php?pagina=usr_app">{$nome_pagina}</a></li>
    ...
    <div class="col-lg-6 col-md-8 col-sm-10">
      <form method="POST" name="frmSave" enctype="multipart/form-data" id="frmSave"
        action="index.php?pagina=usr_app{if isset($acao)}&acao={$acao}{/if}&send=1{if isset($id_atualiza)}&id={$id_atualiza}{/if}">
        ...
        <div class="form-group">
          <a href="{$URL}index.php?pagina=usr_app" class="btn btn-primary">Voltar</a>
